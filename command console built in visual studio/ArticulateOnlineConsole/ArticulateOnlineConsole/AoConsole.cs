...
using  ArticulateOnlineConsole.ArticulateOnline;
...
namespace ArticulateOnlineConsole
{
    class AoConsole
    {
        ...
        static bool listUsers(string url, Credentials c)
        {
            ...
            ArticulateOnline.ArticulateOnline ao = new ArticulateOnline.ArticulateOnline();
            ao.Url = url;
        ...
        static int Main(string[] args)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        case "CreateUsers":
                            if (ensureArgs(args, 0))
                            {
                                string[] emailAddress = new string[] { "abcd1234c@asdf.com", "abcd5678b@asdf.com", "abcd5678c@asdf.com" };
                                string[] memberOfGroupIds = new string[] { "5e523481-856c-481f-a957-1d66473276e5", "5e523481-856c-481f-a957-1d66473276e5", "5e523481-856c-481f-a957-1d66473276e5" };

                                success = createUsers(url, c, emailAddress, memberOfGroupIds, "letmein123", false, false, "TEST");
